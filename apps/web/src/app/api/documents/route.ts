...
import type { DocumentItem, DocumentStatus } from '@echo-ai/core-domain';
  ...
  try {
    ...
    if (contentType.includes('application/json')) {
      ...
      await dynamoDbDocumentClient.send(
        new PutCommand({ TableName: MAIN_TABLE_NAME, Item: item })
      );
    ...
    await dynamoDbDocumentClient.send(dbCommand);
