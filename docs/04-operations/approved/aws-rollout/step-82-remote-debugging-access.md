---
title: 82단계. 원격 디버깅 및 로깅 접근 절차 수립
domain: operations
status: approved
...
## 선행조건
- [40단계 개발용 네트워크 구축](docs/04-operations/approved/aws-rollout/step-40-dev-network-build.md) 결과로 Bastion/VPN 구성이 완료되어야 한다.
- [41단계 IAM 프로비저닝](docs/04-operations/approved/aws-rollout/step-41-iam-provisioning.md)에서 운영/지원 역할이 구분되어 있어야 한다.
- [58단계 모니터링/로그 인프라](docs/04-operations/approved/aws-rollout/step-58-monitoring-logging-provisioning.md) 및 [73단계 문서화 정비](docs/04-operations/approved/aws-rollout/step-73-documentation-refresh.md)가 최신 상태여야 한다.
