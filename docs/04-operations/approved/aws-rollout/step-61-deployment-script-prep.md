...
## 선행조건
- [50단계 IaC 배포 템플릿](docs/04-operations/approved/aws-rollout/step-50-iac-deployment-templates.md) 완성.
- [29단계 CD 도구 선정](docs/04-operations/approved/aws-rollout/step-29-cd-tool-selection.md) 및 [49단계 CD 부트스트랩](docs/04-operations/approved/aws-rollout/step-49-cd-tool-bootstrap.md) 완료.
- [51단계 구성 관리 계획](docs/04-operations/approved/aws-rollout/step-51-configuration-management-plan.md)과 [52단계 설정 파일 준비](docs/04-operations/approved/aws-rollout/step-52-application-config-prep.md) 산출물 확보.
