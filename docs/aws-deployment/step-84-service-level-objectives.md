...
## 선행조건
- [83단계 운영용 대시보드](docs/aws-deployment/step-83-operations-dashboard.md)에서 주요 지표가 시각화되어 있어야 한다.
- [68단계 성능 테스트 계획](docs/aws-deployment/step-68-performance-test-planning.md) 및 [69단계 성능 테스트 실행](docs/aws-deployment/step-69-performance-test-execution.md) 결과로 기준 데이터를 확보해야 한다.
- [74단계 운영 핸드오프 계획](docs/aws-deployment/step-74-operations-handoff-plan.md)에서 운영 책임 및 대응 체계가 정리되어 있어야 한다.
