...
## 선행조건
- [26단계 모니터링 및 로깅 프레임워크](docs/aws-deployment/step-26-monitoring-logging-framework.md).
- [36단계 비용 모니터링 초안](docs/aws-deployment/step-36-cost-monitoring.md) 및 [37단계 태깅 규칙](docs/aws-deployment/step-37-resource-tagging.md).
