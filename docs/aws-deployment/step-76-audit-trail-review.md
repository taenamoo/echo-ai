...
## 선행조건
- [7단계 보안 및 규제 요구사항 분석](docs/aws-deployment/step-07-security-compliance.md) 결과 확보.
- [8단계 거버넌스 원칙](docs/aws-deployment/step-08-governance-principles.md)과 [37단계 태그 정책](docs/aws-deployment/step-37-resource-tagging.md) 정의 완료.
- [58단계 모니터링 인프라](docs/aws-deployment/step-58-monitoring-logging-provisioning.md) 및 [59단계 로그 보존 정책](docs/aws-deployment/step-59-log-collection-retention.md) 적용 완료.
