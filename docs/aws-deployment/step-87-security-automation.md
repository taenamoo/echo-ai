...
## 선행조건
- [57단계 보안 스캔 운영](docs/aws-deployment/step-57-security-scan-review.md)과 [81단계 보안 정책 준수 감사](docs/aws-deployment/step-81-security-compliance-audit.md) 결과가 준비되어야 한다.
- [76단계 감사 추적 검토](docs/aws-deployment/step-76-audit-trail-review.md)에서 로그 수집/보존이 정상 동작해야 한다.
- [75단계 보안 사고 대응 절차](docs/aws-deployment/step-75-security-incident-response.md)에서 정의된 대응 단계와 일치해야 한다.
