...
## 선행조건
- [65단계 최초 배포](docs/aws-deployment/step-65-initial-dev-deployment.md) 완료.
- [26단계 모니터링 프레임워크](docs/aws-deployment/step-26-monitoring-logging-framework.md)와 [58단계 관측 인프라](docs/aws-deployment/step-58-monitoring-logging-provisioning.md) 구성.
- [52단계 설정 파일](docs/aws-deployment/step-52-application-config-prep.md)에서 헬스체크 엔드포인트가 정의되어야 한다.
