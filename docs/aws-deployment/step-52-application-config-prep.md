...
## 선행조건
- [22단계 시크릿 관리 방안](docs/aws-deployment/step-22-runtime-secrets-management.md) 및 [38단계 시크릿 운영 절차](docs/aws-deployment/step-38-secrets-operations.md).
- [45단계 빌드 시크릿 주입](docs/aws-deployment/step-45-build-secrets-injection.md) 설정.
