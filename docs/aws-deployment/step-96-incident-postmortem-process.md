...
## 선행조건
- [89단계 장애 대응 훈련](docs/aws-deployment/step-89-incident-response-drill.md)과 [75단계 사고 대응 절차](docs/aws-deployment/step-75-security-incident-response.md)가 문서화되어 있어야 한다.
- [95단계 릴리즈 기록](docs/aws-deployment/step-95-release-notes-management.md)과 [94단계 변경 관리 로그](docs/aws-deployment/step-94-change-management-process.md)가 수집되고 있어야 한다.
