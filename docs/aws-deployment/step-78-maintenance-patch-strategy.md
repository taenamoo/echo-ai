...
## 선행조건
- [51단계 구성 관리 계획](docs/aws-deployment/step-51-configuration-management-plan.md) 및 도구 설정 완료.
- [65단계 최초 배포](docs/aws-deployment/step-65-initial-dev-deployment.md) 결과와 배포 스크립트 사용 방법 파악.
- [75단계 사고 대응 절차](docs/aws-deployment/step-75-security-incident-response.md)와 [77단계 스케일링 정책](docs/aws-deployment/step-77-auto-scaling-policy.md) 내용 확인.
