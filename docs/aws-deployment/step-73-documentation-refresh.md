...
## 선행조건
- [2단계 애플리케이션 아키텍처 문서](docs/aws-deployment/step-02-application-architecture.md) 최신 버전 확보.
- [14단계 네트워크 설계](docs/aws-deployment/step-14-network-design-draft.md), [27단계 CI/CD 요구사항](docs/aws-deployment/step-27-cicd-requirements.md) 및 이후 실행 결과 수집.
- [65단계 최초 배포](docs/aws-deployment/step-65-initial-dev-deployment.md)와 [67단계 기능 검증](docs/aws-deployment/step-67-functional-validation.md) 보고서 참조.
