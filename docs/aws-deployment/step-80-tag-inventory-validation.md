...
## 선행조건
- [35단계 저장소 거버넌스](docs/aws-deployment/step-35-repository-governance.md)와 [37단계 태그 정책](docs/aws-deployment/step-37-resource-tagging.md) 준수 기준 확보.
- [58단계 모니터링 인프라](docs/aws-deployment/step-58-monitoring-logging-provisioning.md) 및 [76단계 감사 추적 검토](docs/aws-deployment/step-76-audit-trail-review.md) 완료.
- [71단계 비용 알람](docs/aws-deployment/step-71-cost-monitoring-alerts.md)에서 사용되는 비용 할당 태그 목록 확인.
