---
title: 배포 차단 요소 조치 현황 (Section 1)
domain: records
status: approved
...
- `docs/04-operations/approved/aws-rollout/pre-deployment-gap-analysis-approved.md`
...
3. Next.js App Router의 API 구현을 제거하고, SPA API 클라이언트가 `VITE_API_BASE_URL` 기반으로 API Gateway를 직접 호출하도록 프런트엔드를 정리했습니다. 【F:apps/spa/src/api.ts†L1-L71】【F:apps/spa/src/routes/Documents.tsx†L1-L260】【F:apps/spa/src/routes/Study.tsx†L1-L200】
...
- `apps/spa/src/api.ts`
- `apps/spa/src/routes/Documents.tsx`
- `apps/spa/src/routes/Study.tsx`
...
- `docs/02-architecture/approved/current-system-overview-approved.md`
- `docs/04-operations/approved/aws-rollout/current-deployment-steps-approved.md`
- `docs/04-operations/approved/aws-rollout/pre-deployment-gap-analysis-approved.md`
...
- Secrets 회전 자동화, 모니터링, 레거시 앱 정리 등 남은 리스크는 `docs/02-architecture/approved/current-system-overview-approved.md`에 요약해 두고 후속 계획을 수립하고 있습니다.
